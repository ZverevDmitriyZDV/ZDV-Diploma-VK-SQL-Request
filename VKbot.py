        ...
        for event in self.server_pool.listen():
            ...
            if step_action == 2:
                ...
                self._write_msg(self.user_id,
                                ...
                                'партнера\n '
                                'Если вы ищети человека своего возраста и из ващего города, то вводите "метч"')
            ...
            if step_action == 4:
                if user_msg == 'далее':
                    self._write_msg(self.user_id, f'Высылаю преварительные результаты.Следующая попытка:')
